...
import 'schema/popular_doctors_record.dart';
import 'schema/bookings_record.dart';
import 'schema/past_bookings_record.dart';
...
export 'schema/popular_doctors_record.dart';
export 'schema/bookings_record.dart';
export 'schema/past_bookings_record.dart';
...
/// Functions to query PopularDoctorsRecords (as a Stream and as a Future).
Future<int> queryPopularDoctorsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PopularDoctorsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PopularDoctorsRecord>> queryPopularDoctorsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PopularDoctorsRecord.collection,
      PopularDoctorsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PopularDoctorsRecord>> queryPopularDoctorsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
